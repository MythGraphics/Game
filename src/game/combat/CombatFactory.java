...
public class CombatFactory {
    ...
    public static Enemy getDefaultFeuerZerg() {
        ...
        c.addWeapon( new Weapon( "rasiermesserscharfe Klauen", DOLCH, PHYSISCH, 25 ));
        c.addWeapon( new Weapon( "langer, spitzer Stachel", SCHWERT, PHYSISCH, 10 ));
    ...
    public static Enemy getDefaultKriegerZerg() {
        ...
        c.addWeapon( new Weapon( "rasiermesserscharfe Klauen", DOLCH, PHYSISCH, 5 ));
        c.addWeapon( new Weapon( "langer, spitzer Stachel", SCHWERT, PHYSISCH, 10 ));
        c.setImg( scale( BINARYIO.loadImage( "sprites/minion/zerg.png" ), 100 ));
        return c;
    }
    ...
    public static Enemy getDefaultBattlePet_Ratte() {
        ...
        c.addWeapon( new Weapon( "rasiermesserscharfe Krallen", KRIEGSCLEVE, PHYSISCH, 5 ));
        c.addWeapon( new Weapon( "giftiger Biss", DOLCH, GIFT, 15 ));
    ...
    public static Enemy getDefaultBattlePet_Katze() {
        ...
        c.addWeapon( new Weapon( "rasiermesserscharfe Krallen", KRIEGSCLEVE, PHYSISCH, 5 ));
        c.addWeapon( new Weapon( "kräftiger Biss", DOLCH, PHYSISCH, 5 ));
    ...
    public static Enemy getDefaultBattlePet_Hase() {
        ...
        c.addWeapon( new Weapon( "brennende Krallen", KRIEGSCLEVE, FEUER, 5 ));
        c.addWeapon( new Weapon( "brennender Biss", DOLCH, FEUER, 5 ));
