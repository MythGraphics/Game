...
public class MoveableSprite extends BlockTile implements Moveable {

    final AnimationPlayer[] aniset;
    final Point maxPoint;
    final int blockSize;

    public MoveableSprite(AnimationPlayer[] aniset, IsBlockType bType,
    ...
    public MoveableSprite(AnimationData[] dataSet, IsBlockType bType,
                          int x, int y, int blockSize, Point maxPoint) {
     ...
     * @return
     */
    public static MoveableSprite create(Map<Direction, AnimationData> animMap, IsBlockType bType,
                                        int x, int y, int blockSize, Point maxPoint) {
        ...
        return new MoveableSprite(players, bType, x, y, blockSize, maxPoint);
    }

    /**
     * Erstellt einen MoveableSprite, der für ALLE Richtungen dieselbe Animation nutzt.
     * @param data
     * @param bType
     * @param x
     * @param y
     ...
     * @return
     */
    public static MoveableSprite createSingleAnimation(AnimationData data, IsBlockType bType,
                                                       int x, int y, int blockSize, Point maxPoint) {
        Direction[] dirs = Direction.values();
        AnimationPlayer[] players = new AnimationPlayer[dirs.length];
